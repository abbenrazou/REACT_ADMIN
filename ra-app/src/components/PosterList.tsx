import { Datagrid, ImageField, List, NumberField, ReferenceField, TextField, useRecordContext ,EditButton
    ,TopToolbar,SelectColumnsButton,ExportButton,DatagridConfigurable,
} from 'react-admin';
...
const UrlField = ({source}:{source:string})=>{
    ...
    return <a href={record[source]} target="_blank">View</a>;
}
